...
export const metadata: Metadata = {
  ...
  description: "Perfil Gabriel Sgaria | Daly Games",
}
...
export function FavoriteCard() {
    ...
    return (
        <div className="w-full bg-gray-900 text-zinc-50 p-4 h-44 rounded-lg flex justify-between flex-col">
            {showInput ? (
            ...
            {!gameName && (
                <p className="font-bold text-zinc-50">Adicionar jogo</p>
            )}
        </div>
    )
}